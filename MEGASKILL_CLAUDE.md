---
name: humanizar-escritura-cientifica
description: mejora-textos-academicos-para-que-suenen-naturales-y-humanos
---
...
## Objetivo
Transformar textos generados por IA en escritura natural, clara y humana sin perder rigor científico.
...
1. Identificar la idea principal del texto.
2. Reorganizar frases para mejorar la claridad.
3. Sustituir palabras genéricas por términos más precisos.
4. Introducir transiciones naturales entre ideas.

## Regla final
Entrega únicamente el texto final mejorado sin explicar el proceso.
